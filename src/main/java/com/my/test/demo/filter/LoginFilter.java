...
public class LoginFilter implements Filter {
    ...
    String[] includeUrls = new String[]{"/user/list","/user/token","/user/updateAge2","/user/updateAge","/user/order/add","/user/get_name","/user/index","/user/online","/user/add","/user/add-redis"};
